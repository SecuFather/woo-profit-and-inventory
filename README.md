...
## Privacy & Tech
- **Local First**: All processing happens in your browser. No data is ever uploaded to a server.
- **Persistent**: Uses `localStorage` to save your configurations and historical data.
- **Portable**: Includes a Backup & Restore feature for easy data portability.
